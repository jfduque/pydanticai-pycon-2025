...
class AgentResponse(BaseModel):
    ...
    summary: str = Field(
        description="Concise American English summary of the user's request."
    )
    response_text: str = Field(
        description="The agent's response to the user (affirmation or polite refusal), in the original language of the request."
    )
